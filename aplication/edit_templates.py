...
def insert_login_button(self, file, sessions):
    ...
    if "sid" in cookies:
        ...
        if (cookies["sid"] in sessions):
            ...
            file = file.replace("$logowanie", "<a href=\"messages\"><button class=\"button\"><img src=\"messages.png\"></button></a> <a href=\"profile_page\"><button class=\"button\">Profil</button></a><a href=\"log_out\"><button class=\"button\">Wyloguj się</button></a>")
        else:
